...
- (void)createViews
{
    ...
    self.spinner.transform = CGAffineTransformMakeScale(2.00, 2.00);
    ...
    self.spinner.backgroundColor = [UIColor colorWithRed:0.0f/255.0f green:0.0f/255.0f blue:0.0f/255.0f alpha:0.5];
